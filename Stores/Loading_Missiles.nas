...
var address           = "test";
	...
	if(name =="Matra MICA"){
		...
		maxg = 50;                                       #<!-- In turn -->
		thrustlbs=250;                                    # <!-- guess -->
		thrustdurationsec = 25;                           #<!-- Mk.36 Mod.7,8 -->
		...
		rail = "true";
		cruisealt = 0;
		thrustlbs1 = 2660;										#thrust will need to be reworked
        thrustlbs2 = 0;
        thrust1durationsec = 5.23;
        thrust2durationsec = 0;
		min_guiding_speed_mach   = 0.8;
		...
		address="Aircraft/eurofighter/Stores/GBU16/gbu16_smoke.xml";
		...
		maxg = 15;
		thrustlbs=610;                                    # <!-- guess -->
		thrustdurationsec =700;                           #<!-- Mk.36 Mod.7,8 -->
		weightlaunchlbs=550;
		weightwarheadlbs=450;
		...
		rail = "true";
		cruisealt = 0;
		thrustlbs1        = 1;#stage 1
		thrustlbs2        = 0;#stage 2
		thrust1durationsec= 1;
		thrust2durationsec= 0;
		min_guiding_speed_mach   = 0.8;
		seeker_angular_speed_dps = 30;   # you want this (much) higher for your modern missiles
		arming_time_sec          = 1.2;  
		...
		trackmaxdeg = 110;                               #<!-- Seeker max total angular rotation -->
		maxg = 15;
		thrustlbs=9000;                                    # <!-- guess -->
		thrustdurationsec =890;                           #<!-- Mk.36 Mod.7,8 -->
