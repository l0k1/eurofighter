...
var init = func() {
	...
	var fuelTank1000Left	=	stations.FuelTank.new("1000L Drop Tank",	"1000L Tank",	8, 265, "sim/model/AV-8B/wingtankLI");
	var fuelTank1000Right	=	stations.FuelTank.new("1000L Drop Tank",	"1000L Tank",	9, 265, "sim/model/AV-8B/wingtankRM");
	var fuelTank1000Center	=	stations.FuelTank.new("1000L Drop Tank",	"1000L Tank",	7, 265, "sim/model/AV-8B/wingtankRM");
	var fuelTank1500Center	=	stations.FuelTank.new("1500L Drop Tank",	"1500L Tank",	7, 400, "sim/model/AV-8B/wingtankRM");
	...
	var pylonSets = {
		...
		l: {name: "1000L Drop Tank", content: [fuelTank1000Left], fireOrder: [0], launcherDragArea: 0.35, launcherMass: 375, launcherJettisonable: 0, showLongTypeInsteadOfCount: 1},
		m: {name: "1000L Drop Tank", content: [fuelTank1000Right], fireOrder: [0], launcherDragArea: 0.35, launcherMass: 375, launcherJettisonable: 0, showLongTypeInsteadOfCount: 1},
		n: {name: "1000L Drop Tank", content: [fuelTank1000Center], fireOrder: [0], launcherDragArea: 0.30, launcherMass: 375, launcherJettisonable: 0, showLongTypeInsteadOfCount: 1},
		o: {name: "1500L Drop Tank", content: [fuelTank1500Center], fireOrder: [0], launcherDragArea: 0.30, launcherMass: 375, launcherJettisonable: 0, showLongTypeInsteadOfCount: 1},
	...
	# sets
	var empty 			= 	[pylonSets.empty];
	var station1		=	[pylonSets.empty, pylonSets.n, pylonSets.o];
	var station5L		=	[pylonSets.empty, pylonSets.l];
	var station5R		=	[pylonSets.empty, pylonSets.m];
	...
	# pylons
	var pylon1  = stations.Pylon.new("1 | Center",			0,	[0,0,0],	station1,	0, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[0]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[0]",1));
	var pylon2  = stations.Pylon.new("2 | Left Fuse Aft",	1,	[0,0,0],	empty,		1, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[1]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[1]",1));
	var pylon3  = stations.Pylon.new("2 | Right Fuse Aft",	2,	[0,0,0],	empty,		2, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[2]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[2]",1));
	var pylon4  = stations.Pylon.new("3 | Left Fuse Fore",	3,	[0,0,0],	empty,		3, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[3]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[3]",1));
	var pylon5  = stations.Pylon.new("3 | Right Fuse Fore",	4,	[0,0,0],	empty,		4, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[4]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[4]",1));
	var pylon6  = stations.Pylon.new("4 | Left Inboard",	5,	[0,0,0],	empty,		5, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[5]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[5]",1));
	var pylon7  = stations.Pylon.new("4 | Right Inboard",	6,	[0,0,0],	empty,		6, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[6]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[6]",1));
	var pylon8  = stations.Pylon.new("5 | Left Center",		7,	[0,0,0],	station5L,	7, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[7]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[7]",1));
	var pylon9  = stations.Pylon.new("5 | Right Center",	8,	[0,0,0],	station5R,	8, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[8]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[8]",1));
	var pylon10 = stations.Pylon.new("6 | Left Outboard",	9,	[0,0,0],	empty,		9, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[9]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[9]",1));
	var pylon11 = stations.Pylon.new("6 | Right Outboard",	10,	[0,0,0],	empty,		10, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[10]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[10]",1));
	var pylon12 = stations.Pylon.new("7 | Left Tip",		11,	[0,0,0],	empty,		11, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[11]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[11]",1));
	var pylon13 = stations.Pylon.new("8 | Right Tip",		12,	[0,0,0],	empty,		12, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[12]",1),	props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[12]",1));
	...
	var pylons = [pylon1,pylon2,pylon3,pylon4,pylon5,pylon6,pylon7,pylon8,pylon9,pylon10,pylon11,pylon12,pylon13];
	var fcs = fc.FireControl.new(pylons, [3,4,1,2,11,12,9,10,7,8,5,6,0], []);
}