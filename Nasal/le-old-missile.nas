var AcModel        = props.globals.getNode("sim/model/eurofighter");
var OurHdg         = props.globals.getNode("orientation/heading-deg");
var OurRoll        = props.globals.getNode("orientation/roll-deg");
var OurPitch       = props.globals.getNode("orientation/pitch-deg");

#Old Stuff from "fox2.nas". can be reused
#var HudReticleDev  = props.globals.getNode("sim/model/eurofighter/instrumentation/radar-awg-9/hud/reticle-total-deviation", 1);
#var HudReticleDeg  = props.globals.getNode("sim/model/eurofighter/instrumentation/radar-awg-9/hud/reticle-total-angle", 1);
#var SwSoundOnOff   = AcModel.getNode("/controls/armament/missile/sound-on-off");
#var SwSoundVol     = AcModel.getNode("/controls/armament/missile/sound-volume");
#var vol_search     = 0.12;
...
var MISSILE = {
        ...
        del: func {
                ...
                if(me.free == 1 and me.Tgt != nil){
                        ...
                        if (getprop("sim/model/eurofighter/systems/armament/mp-messaging")=="true") {
        ...
        release: func() {
                ...
                var aalt = ((me.ac.alt() - 5) * M2FT) + out[2];
        ...
        update_track: func() {
                ...
                if (me.status == 1) {                
                        ...
                        #problem here : We have to calculate the alt difference before we calculate the other coord.
                        #Prevision of the next position with speed & heading and dt->time to next position
                        #Prevision of the next altitude depends on the target appproch on the next second. dt = 0.1
                        #me.vApproch;
...
var MPReport = func () {
        if (getprop("sim/model/eurofighter/systems/armament/mp-messaging")=="true") {
                setprop("sim/model/eurofighter/systems/armament/mp-messaging","false");
        }else{
                setprop("sim/model/eurofighter/systems/armament/mp-messaging","true");
        }
        var phrase = "MP messaging : " ~ getprop("sim/model/eurofighter/systems/armament/mp-messaging");
        setprop("/sim/messages/atc", phrase);
}
