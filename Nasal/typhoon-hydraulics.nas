################################################################################
#                     Typhoon HYDRAULIC SYSTEM
################################################################################

var last_time       = 0.0;
var HYD1_deb        = props.globals.getNode("/systems/hydraulics/suppliers/HYD1_deb",   1);
var HYD1_press      = props.globals.getNode("/systems/hydraulics/suppliers/HYD1_press", 1);
var HYD2_deb        = props.globals.getNode("/systems/hydraulics/suppliers/HYD2_deb",   1);
var HYD2_press      = props.globals.getNode("/systems/hydraulics/suppliers/HYD2_press", 1);
var Circuit1_Press  = props.globals.getNode("/systems/hydraulics/circuit1_press",       1);
var Circuit2_Press  = props.globals.getNode("/systems/hydraulics/circuit2_press",       1);
var Volts           = props.globals.getNode("/systems/electrical/outputs/bus",          1);
# Make it serviceable
props.globals.getNode("/systems/hydraulics/serviceable", 1).setBoolValue(1);
var PWR             = props.globals.getNode("systems/hydraulics/serviceable", 1).getBoolValue();

# pump definition
# pressure in bars 1 bar =100 kPa = 100/6.89 PSI = 100kn/m^2
# deb in l/mn
# the typhoon rpm is in percent - arg2 is then 15.0
...
var hyd_1 = HYDRPUMP.new("/engines/engine[0]/rpm", 15.0, 280.0, 110.0, 28);
var hyd_2 = HYDRPUMP.new("/engines/engine[1]/rpm", 15.0, 280.0, 109.0, 28);
...
var update_virtual_circuits = func(dt)
{
    ...
    # if hydraulic system is not wrecked
    if(PWR)
    {
...
var update_hydraulics = func
{
    ...
    settimer(update_hydraulics, 1);
}

Hydraulics_init = func()
{
    settimer(update_hydraulics, 1);
    print("hydraulics System ... OK");
}
