...
var MissContSound     = AcModel.getNode("/controls/armament/missile/cont-sound");
var MissIntSound      = AcModel.getNode("/controls/armament/missile/int-sound");

var range_radar2      = 0;
var my_radarcorr      = 0;
var wcs_mode          = "rws"; #FIXME should handled as properties choice, not harcoded.
var radarTws		  = props.globals.getNode("instrumentation/radar/mode/tws-auto");
...
var az_scan = func() {
        ...
        if (swp_dir != swp_dir_last) {
                ...
                #remove AI/MP off the radar before reloading it
                #hud.remove_target();
                ...
                foreach( var c; raw_list ) {
                        ...
                        if (type == "multiplayer" or (type == "tanker" and HaveRadarNode != nil) or type == "aircraft" or type=="carrier" or type=="AI") {
                                var u = Target.new(c);
                                u_ecm_signal      = 0;
                                u_ecm_signal_norm = 0;
                                u_radar_standby   = 0;
...
var hud_nearest_tgt = func() {
        ...
        if ( nearest_u != nil ) {
                ...
                if ( (radarTws = 1) and nearest_u.get_display() and nearest_u.deviation > l_az_fld  and  nearest_u.deviation < r_az_fld ) {
...
rwr = func(u) {
        ...
        #Debug
        if(u_maxrange < 1 ){ u_maxrange = 100; }
